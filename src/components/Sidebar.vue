  ...
  <div class="sidebar">
    ...
    'Therapistprofile'
      ...
      <router-link to="/therapist/therapistdataexport" class="list-group-item list-group-item-action bg-dark text-light"><i class="fa fa-file-export"></i>
        ...
        <router-link to="/therapist/therapistsubscriptioninformation" class="list-group-item list-group-item-action bg-dark text-light"><i class="fa fa-Pending Patient Signature"></i>
          Account</router-link>
