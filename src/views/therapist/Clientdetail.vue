<template>
            ...
            <div class="row pt-3">
                ...
                <div class="col-sm">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="clientinfo" role="tabpanel"
                            aria-labelledby="clientinfo">
                        ...
                        <div class="tab-pane fade" id="appointments" role="tabpanel" aria-labelledby="appointments-tab">
                            <div class="col-sm-12 pt-4">
                                ...
                                <ul class="list-group">
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">October 29, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">October 25, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">October 20, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">October 15, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                </ul>
                            </div>
                            <div class="col-sm-12 pt-4">
                                ...
                                <ul class="list-group">
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">October 10, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">October 5, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">September 29, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                    <li class="py-2 list-group-item text-primary cursor-pointer"><a
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"><span
                                                class="fw-bold">September 25, 2022 5:00 PM - 5:55 PM,</span> 55 Min,
                                            90837-George Lockwood</a></li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <ul class="list-group pb-3">
                                                ...
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox2" checked value="option1">
                                                        <label class="form-check-label" for="inlineCheckbox1">Clinical
                                                            Documents</label>
                                                    </div>
                                                    <ul class="list-group">
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Inventories</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Upload</label>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox2" checked value="option1">
                                                        <label class="form-check-label" for="inlineCheckbox1">Intake
                                                            Forms</label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox4" checked value="option2"
                                                            @click="togglenoteSub">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox2">Notes</label>
                                                    </div>
                                                    <ul class="list-group">
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Initial Intake and Treatment
                                                                    Plan</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Schema/Mode Conceptualization
                                                        ...
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Progress Notes</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Process Notes</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Treatment Review</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Termination Note</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Consultation</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Collateral Contact</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item pb-0 border-0">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="inlineCheckbox5" checked value="option2">
                                                                <label class="form-check-label"
                                                                    for="inlineCheckbox2">Chart Note</label>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox5" checked value="option2">
                                                        <label class="form-check-label" for="inlineCheckbox2">Shared
                                                            Documents</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <ul class="list-group pb-3">
                                                ...
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox3" checked value="option2">
                                                        <label class="form-check-label" for="inlineCheckbox2">Pending
                                                ...
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox4" checked value="option2">
                                                        <label class="form-check-label" for="inlineCheckbox2">Reviewed
                                                            by Patient</label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                ...
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox5" checked value="option2">
                                                        <label class="form-check-label" for="inlineCheckbox2">Completed
                                                            by Patient</label>
                                                    </div>
                                                </li>
                                            </ul>
                                                ...
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox3" checked value="option2">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox2">Created</label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox4" checked value="option2">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox2">Category</label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox5" checked value="option2">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox2">Access</label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox5" checked value="option2">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox2">Service</label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox5" checked value="option2">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox2">Received</label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item pb-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="inlineCheckbox5" checked value="option2">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox2">Status</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="email" class="form-control"
                                                        aria-describedby="emailHelp" placeholder="Select start date">
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="email" class="form-control"
                                                        aria-describedby="emailHelp" placeholder="Select end date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 text-center border-bottom py-3">
                                            <button type="button" class="btn btn-outline-dark"
                                                @click="toggleFilter">Reset Filter</button>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="billing" role="tabpanel" aria-labelledby="billing-tab">
                                ...
                                <div class="col-sm-3 d-flex align-items-center">
                                    <div class="input-group">
                                        <input class="form-control border-end-0 border rounded-pill" type="search"
                                            value="Search Transactions" id="example-search-input">
                                        <span class="input-group-append">
                                            <button
                                                class="btn btn-outline-dark bg-white border-bottom-0 border rounded-pill ms-n5"
                                                type="button">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><button class="btn btn-outline-dark"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#payoutdetails">Details</button></th>
                                                <td>12/12/2021</td>
                                                <td></td>
                                                <td>Payout</td>
                                                <td class="text-muted">($378.19 CR) USD</td>
                                                <td class="text-muted">(378.19 CR) USD</td>
                                                <td></td>
                                                <td><button class="btn btn-outline-dark">Refund</button></td>
                                            </tr>
                                            <tr>
                                                <th scope="row"><button class="btn btn-outline-dark"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#paymentdetails">Details</button></th>
                                                <td>12/08/2021</td>
                                                <td></td>
                                                <td>
                                                    Charge<br>
                                                    <small class="text-muted">Visa (...3347)</small>
                                                </td>
                                                <td>($378.19 CR) USD</td>
                                                <td>(390.00 CR) USD</td>
                                                <td>11.81 USD</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    Charge<br>
                                                    <small class="text-muted">MasterCard (...2835)</small>
                                                </td>
                                                <td>($964.44 CR) USD</td>
                                                <td>(994.07 CR) USD</td>
                                                <td>2.02 USD</td>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm">
                                                    <h4>Charge on 12/08/2021 for John Appleseed</h4>
                                                </div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Payment ID</span></div>
                                                <div class="col-sm-6"><span>py_1K4blpAKQ6vC73SAmhQkRjl2</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Statement descriptor
                                                    </span></div>
                                                <div class="col-sm-6"><span>GEORGE LOCKWOOD, PH.D.</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Amount </span></div>
                                                <div class="col-sm-6"><span> $390</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Fee </span></div>
                                                <div class="col-sm-6"><span> $11.81 </span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Net </span></div>
                                                <div class="col-sm-6"><span>$378.19</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Date </span></div>
                                                <div class="col-sm-6"><span>12/08/2021 8:50 pm</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Payout </span></div>
                                                <div class="col-sm-6"><span>12/12/2021 View Payout</span></div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Payment ID</span></div>
                                                <div class="col-sm-6"><span> card_1I41uAKgTRVBkzpcWZuPMm8e</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Payment ID</span></div>
                                                <div class="col-sm-6"><span>py_1K4blpAKQ6vC73SAmhQkRjl2</span></div>
                                            ...
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Name </span></div>
                                                <div class="col-sm-6"><span>John Appleseed</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Number </span></div>
                                                <div class="col-sm-6"><span>•••• 3347</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">CVC check </span></div>
                                                <div class="col-sm-6"><span>py_1K4blpAKQ6vC73SAmhQkRjl2</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Not provided</span></div>
                                                <div class="col-sm-6"><span>py_1K4blpAKQ6vC73SAmhQkRjl2</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Expires </span></div>
                                                <div class="col-sm-6"><span>2 / 2026</span></div>
                                            </div>
                                            <div class="row py-2">
                                                <div class="col-sm-6"><span class="fw-bolder">Type </span></div>
                                                <div class="col-sm-6"><span>Visa</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Payment Details Modal -->
                            <div class="modal fade" id="payoutdetails" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg"
                                    style="z-index:2000;position: relative;">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Payout ID</span></div>
                                                <div class="col-sm-6"><span>po_1K5gpJAKQ6vC73SAkZh1uI8C</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Initiated </span></div>
                                                <div class="col-sm-6"><span> 12/11/2021 </span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Est. Arrival </span></div>
                                                <div class="col-sm-6"><span> 12/12/2021 </span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Description </span></div>
                                                <div class="col-sm-6"><span> Stripe payout</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder">Amount </span></div>
                                                <div class="col-sm-6"><span>$378.19 CR</span></div>
                                            </div>
                                            <div class="row py-2 border-bottom">
                                                <div class="col-sm-6"><span class="fw-bolder"></span></div>
                                                <div class="col-sm-6"><span><a href="">Transactions</a> </span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <select class="form-select my-2" aria-label="Default select example">
                                            <option selected>Simple Progress Note</option>
                                    ...
                                    <div class="col-sm">
                                        <button type="button" class="btn btn-outline-dark mt-2">
                                            Load Previous Note</button>
                                    </div>
                                </div>

                                <div class="row py-3">
                                    <div class="col">
                                        <label for="" class="pb-2 fw-bolder">Simple Progress Note</label>
                                        <textarea class="form-control" placeholder="Add Progress Note..."
                                            style="height: 100px"></textarea>
                                    </div>
                                    <div class="col-sm-12 text-end pt-2">
                                        <button type="button" class="btn btn-outline-dark mx-2">Cancel</button>
                                ...
                                <div class="row py-3">
                                    <div class="col-sm-12">
                                        <label for="" class="pb-2 fw-bolder">Psychotherapy Note</label>
                                        <textarea class="form-control" placeholder="Add Psychotherapy Note..."
                                            style="height: 100px"></textarea>
                                    </div>
                                    <div class="col-sm-12 text-end pt-2">
                                        <button type="button" class="btn btn-outline-dark mx-2">Cancel</button>
                                ...
                                <div class="d-flex my-4 justify-content-center">
                                    ...
                                    <button type="button" class="btn btn-primary"><i class="fas fa-save me-1"></i>
                                        Save</button>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="py-1">
                                        ...
                                        <span class="ms-1">
                                            <span class="badge rounded-pill bg-primary">Show</span>
                                        </span>
                                    </li>
                                    <li class="py-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div class="pb-4">
                                    ...
                                    <button type="button" class="btn btn-outline-dark">
                                        Open in Calendar
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="ms-1 bi bi-arrow-right" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
    ...
    <div class="modal fade" id="senddocumentmodal" tabindex="-1" aria-labelledby="senddocumentmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" style="z-index:2000;position: relative;">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <VSelect v-model="selected" :options="countries" />
                    </div>
                    <div class="row pt-3">
                        <div class="col-sm">
                            <label for="" class="fw-bolder">Selected Documents:</label>
                            <ul class="list-group">
                                <li class="py-2 list-group-item"> Example Document <svg
    ...
    <!-- New Notes Modal Start -->
    <div class="modal fade" id="newprogressnote" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" style="z-index:2000;position: relative;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Psychotherapy Progress Note</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
