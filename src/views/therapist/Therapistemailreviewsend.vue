                ...
                <div class="col-sm-12">
                    <div class="shadow-sm rounded-3 p-3 border">
                        <div class="row">
                            ...
                            <div class="col-md-4 d-flex align-items-sm-center">
                                <div>
                                    <span class="d-block py-1 fw-bolder">
                                    ...
                                    <span class="d-block py-1">
                                        ...
                                        Thursday, January 6, 2022 from 9:00am - 9:55 am
                                    </span>
                                    <span class="d-block py-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-camera-video me-1" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M0 5a2 2 0 0 1 2-2h7.5a2 2 0 0 1 1.983 1.738l3.11-1.382A1 1 0 0 1 16 4.269v7.462a1 1 0 0 1-1.406.913l-3.111-1.382A2 2 0 0 1 9.5 13H2a2 2 0 0 1-2-2V5zm11.5 5.175 3.5 1.556V4.269l-3.5 1.556v4.35zM2 4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h7.5a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H2z"/>
                                          </svg>
                                        90837 (Psychotherapy, 60 min) at Video Office
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-4 d-flex align-items-sm-center justify-content-center">
                    ...
                    <div class="row pt-3">
                        <div class="col-sm">
                            ...
                            <router-link data-bs-toggle="modal" data-bs-target="#shareModal" to="/therapist/therapistcalendar" class="btn btn-outline-dark ms-2" >
                                Share & Send Now
