    ...
    <div class="faq">
        <div class="container">
            ...
            <div class="alert alert-info text-center mt-3" role="alert">
                Please  <router-link  type="button" to="/entercode">register</router-link >  to schedule a session
            ...
            <div class="card p-3 my-3 shadow-sm" v-for="therapist in selectTherapist" :key="therapist.id"
                ...
                <div class="d-flex">
                    ...
                    <div class="text-left ps-3">
                        ...
                        <button type="button" class="btn btn-primary ms-2" disabled @click="selectTherapistSchedule">Schedule
